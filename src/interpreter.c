...
#define SECT_ENTER_INTERP JL_SECTION("jl_enter_interpreter_frame_val")

#elif defined(_OS_DARWIN_)
extern uintptr_t __start_jl_enter_interpreter_frame_val __asm("section$start$__TEXT$__jeif");
uintptr_t __start_jl_enter_interpreter_frame = (uintptr_t)&__start_jl_enter_interpreter_frame_val;
extern uintptr_t __stop_jl_enter_interpreter_frame_val __asm("section$end$__TEXT$__jeif");
uintptr_t __stop_jl_enter_interpreter_frame = (uintptr_t)&__stop_jl_enter_interpreter_frame_val;
...
asm(
    ...
    "\tcallq *%rax\n"
    "enter_interpreter_frame_end_val:\n"
    "\taddq $56, %rsp\n"
...
extern uintptr_t enter_interpreter_frame_start_val;
extern uintptr_t enter_interpreter_frame_end_val;
